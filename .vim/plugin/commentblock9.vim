...
if !has("g:comment_key")
    g:comment_key = "\<C-_>"
#    g:comment_key = "\<C-/>"
endif
var SID = expand("<SID>")

execute "nnoremap <expr> " .. g:comment_key .. " " .. SID .. "StartCommentBlock()"
execute "vnoremap <expr> " .. g:comment_key .. " " .. SID .. "StartCommentBlock()"
execute "nnoremap <expr> " .. repeat(g:comment_key, 2) .. " " .. SID .. "StartCommentBlock() .. '_'"
