...
:hi FileModified guifg=#f2ff00 ctermbg=240
:hi FileNoModified guifg=#0000ff ctermbg=240
:hi FileModifiedNC guifg=#f2ff00 ctermbg=235
:hi FileNoModifiedC guifg=#0000ff ctermbg=235 

" Color for type of file
:hi FileType guifg=#000f5c ctermbg=240
...
" -normal
:hi NormalMode guifg=#000f5c ctermbg=240
" -insert
:hi InsertMode guifg=#00fff2 guibg=240
" -visual
:hi VisualMode guifg=#004ac9 ctermbg=240
" -replace
:hi ReplaceMode guifg=#ffdd00 ctermbg=240
" -select
:hi SelectlMode guifg=#004ac9 ctermbg=240
